...
extension UIImage {
    ...
    func DSAlert_ApplyTintEffectWithColor(_ tintColor : UIColor) -> UIImage! {
    ...
    func DSAlert_ApplyBlurWithRadius(blurRadius : Float, tintColor : UIColor?, saturationDeltaFactor : Double, maskImage : UIImage?) -> UIImage! {
    ...
    //MARK: - 纯颜色转图片
    static func DSAlert_ImageWithColor(_ color : UIColor) -> UIImage! {
        return self.DSAlert_ImageWithColor(color, size: CGSize(width: 1.0, height: 1.0))
    }
    
    static func DSAlert_ImageWithColor(_ color : UIColor, size : CGSize) -> UIImage! {
